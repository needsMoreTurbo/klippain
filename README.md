...
```bash
wget -O - https://raw.githubusercontent.com/needsMoreTurbo/klippain/custom_changes/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/needsMoreTurbo/klippain/custom_changes/uninstall.sh | bash
```
